...
var camera, scene, renderer;
			...
			function init() {
				...
				scene.fog = new THREE.Fog( 0x1e1e1e, 700, 2100 );
				...
				var mapA = textureLoader.load( "images/particle-square.gif", createHUDSprites );
				var mapB = textureLoader.load( "images/particle-square.gif" );

				mapC = textureLoader.load( "images/particle-square.gif" );
				...
				for ( var a = 0; a < amount; a ++ ) {
					...
					if(rand > 0.65){
						//material.color.setHSL( 0.5 * Math.random(), 0.75, 0.5 );
						//material.color.setRGB(65,45,231)
						material.color.setHex(0x6251f3);
					}

					var sprite = new THREE.Sprite( material );
					sprite.position.set( x, y, z );
					sprite.position.normalize();
					sprite.position.multiplyScalar( getRandomInt(400,500) );
					group.add( sprite );
				}
				scene.add( group );
				// renderer
